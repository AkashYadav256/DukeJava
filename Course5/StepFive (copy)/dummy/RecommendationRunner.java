...
public class RecommendationRunner implements Recommender {
    ...
    public ArrayList<String> getItemsToRate () {
      ...
      temp = sr.getAverageRatingsByFilter(10, af);
      for (Rating r : temp) {
      ...
      //System.out.println("Found "+temp.size()+" movies");
      return ans;
    }
    ...
    public void printRecommendationsFor (String webRaterID) {
      ...
      if (ans1.size() == 0) {System.out.println("No suitable movies for you unfortunately :-(");}
      else {
        ans = ans1.subList(0, 15);
        System.out.println("Please grab your propcorn and enjoy your favorite movies! :-)");
        System.out.println("  ");
        for (Rating r : ans) {
          System.out.println("Title of the movie: " + MovieDatabase.getTitle(r.getItem()));
          System.out.println("Year of release: " + MovieDatabase.getYear(r.getItem()));
          System.out.println("Genres featured: " + MovieDatabase.getGenres(r.getItem()));
          System.out.println("Length of the movie in minutes: " + MovieDatabase.getMinutes(r.getItem()));
          System.out.println("Director(s) of the movie: " + MovieDatabase.getDirector(r.getItem()));
          System.out.println("  ");
          //ans.add(r.getItem());
        }
    }
